                ...
                <div class="panel-body">
                    <div>
                        <ul id="nav-Admin" class="nav">
                            ...
                            <li id="Modif_Jeu"> <a href="MonCompte-Admin-Modif-Jeu.php"><p class="p-active"> Modifier un jeu </p></a> </li>
                    ...
                    <form class="form" action="phpRequetes/modify_game.php" method="post" id="registrationForm">

                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="modified_game" ><h4><u> Choix du Jeu :</u></h4></label>
                                    <select name="modified_game" class="form-control">
                                        <?php
                                        $all_games = $db->query("Select * from games");
                                        foreach($all_games as $user){
                                            ?>
                                            <option value=<?php echo "\"" . $user["id_game"] . "\""; ?> > <?php echo $user["id_game"] . "-" . $user["game_title"]; ?> </option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <?php if(isset($_SESSION["modif_game_info"])){ ?>
                            <p style="color: green"><?php if(isset($_SESSION["modif_game_info"]) || $_SESSION["modif_game_info"] != null){ echo $_SESSION["modif_game_info"]; $_SESSION["add_game_err"] = null;}?></p>
                        <?php } ?>

                        <?php if(isset($_SESSION["modif_game_err"])){ ?>
                            <p style="color: red"><?php if(isset($_SESSION["modif_game_err"]) || $_SESSION["modif_game_err"] != null){ echo $_SESSION["modif_game_err"]; $_SESSION["modif_game_info"] = null;}?></p>
                        <?php } ?>

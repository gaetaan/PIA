...
<div class="container">
    <br>
    <br>
    <h2><u>Termes et conditions :</u></h2>
    <br>
    <dl>


        <br>
        <dt><u> Article 1 : Introduction</u></dt>
        ...
        <dd>Les jeux vidéos sont la propriété du magasin. Il est donc interdit de les abîmer, les louer ou les vendre à d'autres personnes.</dd>
        <br>
        <dt><u>Article 6 : Résiliation d'un abonnement</u></dt>
        <dd>Il est possible à tout moment pour un utilisateur de résilier son abonnnement ou de changer d'abonnement à tout moment en magasin ou depuis le site web.</dd>
        <br>
        <dt><u>Article 7 : Paiement mensuel</u></dt>
        <dd>Le paiement mensuel se fera par versement mensuel directement depuis le compte courant de l'utilisateur.</dd>
    </dl>
    <br>
</div>

                ...
                <div class="panel-body">
                    <div>
                        <ul id="nav-Admin" class="nav">
                            ...
                            <li id="Modif_User"><a href="MonCompte-Admin-Modif-User.php"><p class="p-active"> Modifier un Utilisateur </p></a></li>
                        </ul>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="modified_user" ><h4><u> Choix de l'utilisateur :</u></h4></label>
                                    <select name="modified_user" class="form-control">
                                        <?php
                                            $all_users = $db->query("Select * from users");
                                            foreach($all_users as $user){
                                        ?>
                                        <option value=<?php echo "\"" . $user["id_user"] . "\""; ?> > <?php echo $user["id_user"] . "-" . $user["user_name"] . " " . $user["user_firstname"]; ?> </option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
